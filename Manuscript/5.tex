...
\cite{Kempes:2012hy,more}\sid{fix Ref}. More specifically, the cross-species trends in growth rate can be
approximated by
\begin{eqnarray}
...
This assumption implies a simple metabolic balance where the left hand side of Equation \ref{balance} becomes zero and we have \begin{eqnarray}
